...
for funcType in opfunu.get_functions_based_classname("2013")[6:7:1]: 
  for i in range(10):  
    ...
    with open('log/isoma_results.txt', 'a') as f:
      f.write("2015"+func.name + "\t" +  str(the_best_cost[0] - func.f_global) + '\n')
